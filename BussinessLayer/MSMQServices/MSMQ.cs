...
namespace BussinessLayer.MSMQServices
{
    public class MSMQ
    {
        ...
        public MSMQ()
        {
            this.messageQueue.Path = @".\private$\Employee";
        ...
        public void ReceiveFromQueue(object sender, ReceiveCompletedEventArgs e)
        {
            try
            {
                ...
                using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"E:\Studies\Bridgelabz\Fellowship--.NET\Web-API\BussinessLayer\MSMQServices\msmq.txt", true))
                {
                    file.WriteLine(data);
                }
